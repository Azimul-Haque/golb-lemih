...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('vendor/bloggy/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('vendor/bloggy/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('vendor/bloggy/assets/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('vendor/bloggy/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
  <link href="{{ asset('vendor/bloggy/assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
