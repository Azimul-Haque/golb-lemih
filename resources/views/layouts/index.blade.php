...
<head>
  ...
  <link href="{{ asset('vendor//assets/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('vendor//assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
  <link href="{{ asset('vendor//assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
