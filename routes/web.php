...
Route::post('/dashboard/abouts/store', 'DashboardController@storeAbout')->name('dashboard.abouts.store');
Route::post('/dashboard/abouts/{id}/update', 'DashboardController@updateAbout')->name('dashboard.abouts.update');
Route::get('/dashboard/abouts/{id}/delete', 'DashboardController@deleteAbout')->name('dashboard.abouts.delete');
